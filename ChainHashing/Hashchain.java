...
public class Hashchain{
    public static void main(String[] args) {
        ...
        while(true){
            System.out.println("enter value to insert or enter -1 to not enter the value");
            int value=sc.nextInt();
            if(value==-1){
                break;
            }
            int index=value%10;
            bst[index].insert(value);
        }
        System.out.println("So the output of the chain hashed tree..");
        for(int i=0;i<10;i++){
            bst[i].printinorder();
            System.out.println("-------");
        }
